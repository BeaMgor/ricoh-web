...
import com.ricoh.business.model.UsuarioModel;
...
public class UsuarioModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"correo", Types.VARCHAR}, {"fecha", Types.TIMESTAMP}
	};
	...
	public static final String TABLE_SQL_CREATE =
		"create table USUARIO_Usuario (uuid_ VARCHAR(75) null,usuarioId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,nombre VARCHAR(100) null,apellidos VARCHAR(75) null,correo VARCHAR(75) null,fecha DATE null)";
	...
	public Usuario cloneWithOriginalValues() {
		...
		usuarioImpl.setGroupId(this.<Long>getColumnOriginalValue("groupId"));
		usuarioImpl.setCompanyId(
			this.<Long>getColumnOriginalValue("companyId"));
		usuarioImpl.setUserId(this.<Long>getColumnOriginalValue("userId"));
		usuarioImpl.setUserName(
			this.<String>getColumnOriginalValue("userName"));
		usuarioImpl.setCreateDate(
			this.<Date>getColumnOriginalValue("createDate"));
		usuarioImpl.setModifiedDate(
		...
		usuarioImpl.setFecha(this.<Date>getColumnOriginalValue("fecha"));
	...
	static {
		...
		columnBitmasks.put("correo", 1024L);

		columnBitmasks.put("fecha", 2048L);
