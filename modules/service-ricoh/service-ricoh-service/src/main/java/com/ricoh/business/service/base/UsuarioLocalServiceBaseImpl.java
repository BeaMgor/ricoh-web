...
package com.ricoh.business.service.base;
...
import com.ricoh.business.service.UsuarioLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ricoh.business.service.impl.UsuarioLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ricoh.business.service.impl.UsuarioLocalServiceImpl
 * @generated
 */
public abstract class UsuarioLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, UsuarioLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>UsuarioLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>UsuarioLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return usuarioPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Usuario.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return usuarioPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return usuarioPersistence.countWithDynamicQuery(
	...
	public Usuario fetchUsuarioByUuidAndGroupId(String uuid, long groupId) {
		return usuarioPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(usuarioLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Usuario.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("usuarioId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Usuario.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("usuarioId");
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<Usuario>() {

				@Override
				public void performAction(Usuario usuario)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, usuario);
				}

			});
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(Usuario.class.getName())));
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return usuarioPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return usuarioLocalService.deleteUsuario((Usuario)persistedModel);
	}

	@Override
	public BasePersistence<Usuario> getBasePersistence() {
	...
	public List<Usuario> getUsuariosByUuidAndCompanyId(
		...
		return usuarioPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Usuario> getUsuariosByUuidAndCompanyId(
		...
		return usuarioPersistence.findByUuid_C(
	...
	public Usuario getUsuarioByUuidAndGroupId(String uuid, long groupId)
		...
		return usuarioPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			UsuarioLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		usuarioLocalService = (UsuarioLocalService)aopProxy;

		_setLocalServiceUtilService(usuarioLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return UsuarioLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = UsuarioLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, usuarioLocalService);
		}
