...
package com.ricoh.business.service.persistence.impl;
...
import com.ricoh.business.model.UsuarioTable;
import com.ricoh.business.model.impl.UsuarioImpl;
import com.ricoh.business.model.impl.UsuarioModelImpl;
import com.ricoh.business.service.persistence.UsuarioPersistence;
import com.ricoh.business.service.persistence.UsuarioUtil;
import com.ricoh.business.service.persistence.impl.constants.USUARIOPersistenceConstants;
...
public class UsuarioPersistenceImpl
	...
	public Usuario findByUUID_G(String uuid, long groupId)
		...
		Usuario usuario = fetchByUUID_G(uuid, groupId);
	...
	public Usuario fetchByUUID_G(
		...
		if (result instanceof Usuario) {
			...
			if (!Objects.equals(uuid, usuario.getUuid()) ||
	...
	public Usuario removeByUUID_G(String uuid, long groupId)
		...
		Usuario usuario = findByUUID_G(uuid, groupId);
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(usuario.uuid IS NULL OR usuario.uuid = '') AND ";
	 ...
	 */
	@Override
	public List<Usuario> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	 ...
	 */
	@Override
	public List<Usuario> findByUuid_C(
	...
	public Usuario findByUuid_C_First(
		...
		Usuario usuario = fetchByUuid_C_First(
	...
	public Usuario fetchByUuid_C_First(
		...
		List<Usuario> list = findByUuid_C(
	...
	public Usuario findByUuid_C_Last(
		...
		Usuario usuario = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public Usuario[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, usuario, uuid, companyId, orderByComparator, true);

			array[1] = usuario;

			array[2] = getByUuid_C_PrevAndNext(
				session, usuario, uuid, companyId, orderByComparator, false);
	...
	protected Usuario getByUuid_C_PrevAndNext(
		Session session, Usuario usuario, String uuid, long companyId,
		OrderByComparator<Usuario> orderByComparator, boolean previous) {
	...
	public void cacheResult(Usuario usuario) {
		...
		finderCache.putResult(
			...
			new Object[] {usuario.getUuid(), usuario.getGroupId()}, usuario);
	}
	...
	protected void cacheUniqueFindersCache(UsuarioModelImpl usuarioModelImpl) {
		Object[] args = new Object[] {
			usuarioModelImpl.getUuid(), usuarioModelImpl.getGroupId()
		};

		finderCache.putResult(_finderPathCountByUUID_G, args, Long.valueOf(1));
		finderCache.putResult(_finderPathFetchByUUID_G, args, usuarioModelImpl);
	}
	...
	public Usuario updateImpl(Usuario usuario) {
		...
		if (!usuarioModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				usuario.setModifiedDate(date);
			}
			else {
				usuario.setModifiedDate(serviceContext.getModifiedDate(date));
			}
		}
		...
		cacheUniqueFindersCache(usuarioModelImpl);
