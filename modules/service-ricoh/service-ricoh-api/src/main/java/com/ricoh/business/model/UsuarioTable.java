...
public class UsuarioTable extends BaseTable<UsuarioTable> {
	...
	public final Column<UsuarioTable, Long> groupId = createColumn(
		"groupId", Long.class, Types.BIGINT, Column.FLAG_DEFAULT);
	public final Column<UsuarioTable, Long> companyId = createColumn(
	...
	public final Column<UsuarioTable, Date> modifiedDate = createColumn(
	...
	public final Column<UsuarioTable, Date> fecha = createColumn(
